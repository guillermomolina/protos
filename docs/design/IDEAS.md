...
[`docs/project/history/OPEN_TASKS.md`](https://github.com/guillermomolina/protos-project-docs/blob/main/docs/project/history/OPEN_TASKS.md). A substantive language/design choice still follows
