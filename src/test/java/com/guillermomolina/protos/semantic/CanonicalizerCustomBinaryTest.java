...
class CanonicalizerCustomBinaryTest {
    private final Canonicalizer canonicalizer = new Canonicalizer();

    @Test
    void lowersCustomBinaryOperatorToOrdinaryMessageSend() {
        CanonicalSend send =
                assertInstanceOf(CanonicalSend.class, canonicalizeOnly("left |> right"));
    ...
    @Test
    void preservesLeftAssociativeCustomOperatorTreeDuringLowering() {
        CanonicalSend outer =
                assertInstanceOf(
                        CanonicalSend.class,
                        canonicalizeOnly("a |> b |> c"));
        ...
        assertEquals(
                "a",
                assertInstanceOf(CanonicalLookup.class, inner.receiver()).name());
        assertEquals(
                "b",
