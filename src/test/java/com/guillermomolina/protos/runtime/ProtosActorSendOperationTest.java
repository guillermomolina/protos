...
final class ProtosActorSendOperationTest {
    ...
    void actorRefSendAndSendOperationExposeOnlyTheNormativeLocalSurface() throws Exception {
        ...
        assertEquals(Set.of("send"), actorRefPrototype.localSlotsSnapshot().keySet());
        assertTrue(actorRefPrototype.isFrozen());
        assertTrue(ProtosValueLookup.lookup(target.reference(), "request", fixture.prelude).isEmpty());
    ...
    private static Fixture fixture() throws Exception {
        ...
        ProtosObjectValue actorObject = protocol.createActorObject();
        ProtosActor creator =
