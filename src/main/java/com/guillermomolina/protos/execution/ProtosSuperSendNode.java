...
/** Executes the dedicated canonical {@code super.message(...)} operation. */
public final class ProtosSuperSendNode extends ProtosExpressionNode {
    @Child private ProtosArgumentVectorNode argumentsNode;
    private final String selector;

    public ProtosSuperSendNode(
            SourceSpan span,
            String selector,
            ProtosArgumentVectorNode argumentsNode) {
        super(span);
    ...
    protected Object executeDirect(VirtualFrame frame) {
        ...
        return ProtosInvocation.invokeSuperMessage(selector, supplied, caller);
    }
}
