...
public final class ProtosSendNode extends ProtosExpressionNode {
    ...
    protected Object executeDirect(VirtualFrame frame) {
        ...
        return ProtosInvocation.invokeMessage(receiver, selector, supplied, caller);
    }
}
