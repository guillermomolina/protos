...
See [`CORE_BOOTSTRAP_ARCHITECTURE.md`](https://github.com/guillermomolina/protos-project-docs/blob/main/docs/project/architecture/CORE_BOOTSTRAP_ARCHITECTURE.md).
