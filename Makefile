...
JAVA_SLOW_TEST_EXCLUDES := **/ProtosPackageToolProtosTest.java,**/ProtosExternalPackagePlanningPreflightTest.java,**/ProtosWorkspaceRunCliTest.java,**/ProtosJsonParserModuleTest.java,**/ProtosPackageExecutionPlanAdapterTest.java
